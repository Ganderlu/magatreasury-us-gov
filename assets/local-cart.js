(function () {
  ...
  var COUNTRY_DATA = {
    ...
    Hungary: {
      code: "+36",
      iso: "HU",
      states: ["Budapest", "Debrecen", "Szeged", "Miskolc", "Pécs"],
    },
    India: {
      code: "+91",
      iso: "IN",
    ...
    Slovakia: {
      code: "+421",
      iso: "SK",
      states: ["Bratislava", "Košice", "Prešov", "Žilina", "Nitra"],
    },
    Slovenia: {
      code: "+386",
      iso: "SI",
      states: ["Ljubljana", "Maribor", "Celje", "Kranj", "Velenje"],
    },
    Latvia: {
      code: "+371",
      iso: "LV",
    ...
    Lithuania: {
      code: "+370",
      iso: "LT",
      states: ["Vilnius", "Kaunas", "Klaipėda", "Šiauliai", "Panevėžys"],
    },
    Ukraine: {
      code: "+380",
      iso: "UA",
      states: ["Kyiv", "Lviv", "Odesa", "Kharkiv", "Dnipro"],
    },
    Estonia: {
      code: "+372",
      iso: "EE",
      states: ["Tallinn", "Tartu", "Narva", "Pärnu", "Kohtla-Järve"],
    },
    "South Africa": {
      code: "+27",
      iso: "ZA",
  ...
  function renderCheckoutPage() {
    ...
    countryWrap.innerHTML =
      ...
      '<select class="local-checkout__select"><option value="">---</option></select>' +
      '<span class="local-checkout__select-caret">⌄</span>';

    var countrySel = countryWrap.querySelector("select");
    for (var cName in COUNTRY_DATA) {
